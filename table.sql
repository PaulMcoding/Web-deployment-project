...
-- BMW M2 Competition
insert into car(makeid, car_model, car_price, car_year, car_miles, car_location, car_desc, car_image, seller_id)
values(3, 'M2 Competition', 56999.95, '2018', '35000', 'Munich', 'Ultimate driving pleasure in a compact package', 'https://www.topgear.com/sites/default/files/cars-car/carousel/2018/07/bmw_m2_comp_027.jpg', 1);

-- BMW M3 CS
insert into car(makeid, car_model, car_price, car_year, car_miles, car_location, car_desc, car_image, seller_id)
values(3, 'M3 CS', 78999.99, '2020', '22000', 'Berlin', 'High-performance sedan with a racing spirit', 'https://images.drive.com.au/driveau/image/upload/c_fill,f_auto,g_auto,h_1080,q_auto:eco,w_1920/v1/cms/uploads/ozzwbctnd6qvqfj0xqtw', 1);

-- BMW M4 GTS
insert into car(makeid, car_model, car_price, car_year, car_miles, car_location, car_desc, car_image, seller_id)
values(3, 'M4 GTS', 89999.50, '2017', '18000', 'Hamburg', 'Limited edition track-focused powerhouse', 'https://media.autoexpress.co.uk/image/private/s--X-WVjvBW--/f_auto,t_content-image-full-desktop@1/v1562241066/autoexpress/1/30/m4gts-036_0_0_0_0_0_0.jpg', 1);

-- BMW M8 Competition
insert into car(makeid, car_model, car_price, car_year, car_miles, car_location, car_desc, car_image, seller_id)
values(3, 'M8 Competition', 123555.75, '2022', '9000', 'Frankfurt', 'The pinnacle of luxury and performance', 'https://www.bmw.ie/content/dam/bmw/common/all-models/m-series/m8-coupe/2022/onepager/bmw-m8-coupe-onepager-sp-desktop.jpg', 1);
